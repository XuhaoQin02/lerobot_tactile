...
import cv2
from lerobot.cameras.tactile_cam.neural_gradient.affine_transform import affine_transform
from lerobot.cameras.tactile_cam.neural_gradient.marker_mask import *
from lerobot.cameras.tactile_cam.neural_gradient.circle_mask import get_touch_mask_by_selection
from lerobot.cameras.tactile_cam.neural_gradient.gradient import get_gradient
from lerobot.cameras.tactile_cam.neural_gradient.fast_possion import fast_poisson
from lerobot.cameras.tactile_cam.neural_gradient.model import MLPEncoder
import torch
import numpy as np
...
for i in range(1,2):
    ...
    # img = cv2.imread('data/test2/1-31-0-3.jpg')
    # img = cv2.imread('data/calibration5/cal-80.jpg')
    img = cv2.imread('data/test/disk-1.jpg')
